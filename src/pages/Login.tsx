        ...
        <Auth
          ...
          appearance={{
            ...
            variables: {
              default: {
                colors: {
                  brand: 'hsl(0 84.2% 60.2%)', // Fondo del botón principal en rojo (similar a destructive)
                  brandAccent: 'hsl(0 72.2% 50.6%)', // Fondo del botón principal en hover/activo (un rojo más oscuro)
