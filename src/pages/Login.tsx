        ...
        <Auth
          ...
          appearance={{
            ...
            variables: {
              default: {
                colors: {
                  brand: 'hsl(142.1 76.2% 36.3%)', // Fondo del botón principal en verde (similar a green-600)
                  brandAccent: 'hsl(142.1 70.2% 30.3%)', // Fondo del botón principal en hover/activo (un verde más oscuro)
